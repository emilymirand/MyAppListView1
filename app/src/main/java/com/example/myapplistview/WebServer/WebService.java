package com.example.myapplistview.WebServer;
...
import com.example.myapplication.WebService.HttpRequest;
...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    private com.example.myapplication.WebService.Asynchtask callback=null;

    public com.example.myapplication.WebService.Asynchtask getCallback() {
        return callback;
    }
    public void setCallback(com.example.myapplication.WebService.Asynchtask callback) {
     ...
     */
    public  WebService(String urlWebService,Map<String, String> data, Context activity, com.example.myapplication.WebService.Asynchtask callback) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            com.example.myapplication.WebService.HttpRequest h=new com.example.myapplication.WebService.HttpRequest(this.url,params[0]);
